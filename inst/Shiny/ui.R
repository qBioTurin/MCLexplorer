...
quant_vars <- c(
  "Age" = "Age", "Flow PB" = "flow PB", "Flow BM" = "flow BM",
...
pharmagen_muts <- c(
  "ABCB1 1236 C>T", "ABCB1 2677 G>T,A", "ABCB1 2677 G>T,A _2", "ABCB1 3435 C,T",
...
ui <- dashboardPage(
  dashboardHeader(
    ...
    tags$li(
      a(
        onclick = "window.open('https://github.com/qBioTurin/MCLexplorer')",
        href = NULL,
        icon("github"),
        title = "GitHub",
  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem(
        tabName = "Userclassification",
        HTML('<img src="profile.png" height="20" width="20"> Custom Classification'),
  ...
  dashboardBody(
      ...
      tabItem(
        ...
        fluidRow(
          column(10,
            ...
            h1("MCL explorer", style = "color:#1d8fbd; font-weight:bold; font-size: 48px;"),
            h3("Inspection of MRD kinetics in Mantle Cell Lymphoma", style = "color:#666; font-style: italic;"),
            br(),
            img(src = "MCLlogo.png", height = "150px"),
            br(), br(),
            p("This application is designed to aid researchers in inspecting and classifying CONNECTOR clusters for Minimal Residual Disease in Mantle Cell Lymphoma.",
              style = "font-size:22px; color: #333; max-width: 800px; margin: auto;"
            ),
            br(), br(),
            div(
              class = "row",
              div(
                class = "col-md-4",
                div(
                  style = "padding: 20px; background: #f9f9f9; border-radius: 10px; height: 100%;",
                  icon("search", "fa-3x", style = "color: #1d8fbd;"),
                  h4("Clustering Exploration"),
                  p("Visualize and explore the 'FIL-MCL0208' dataset.")
                )
              ),
              div(
                class = "col-md-4",
                div(
                  style = "padding: 20px; background: #f9f9f9; border-radius: 10px; height: 100%;",
                  icon("project-diagram", "fa-3x", style = "color: #1d8fbd;"),
                  h4("Classification Exploration"),
                  p("Classify data from the 'MCL Younger' dataset.")
                )
              ),
              div(
                class = "col-md-4",
                div(
                  style = "padding: 20px; background: #f9f9f9; border-radius: 10px; height: 100%;",
                  icon("upload", "fa-3x", style = "color: #1d8fbd;"),
                  h4("Custom Classification"),
                  p("Upload and classify your own dataset.")
                )
              )
            ),
            br(), br(),
            img(src = "Framework.png", width = "70%", style = "border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"),
            br(), br(),
            hr(),
            div(
              style = "font-size:14px; color: #666;",
              p("For more information on the connector methodology, please refer to:"),
              tags$a(
                href = "https://academic.oup.com/bioinformatics/article/39/5/btad201/7133735",
                target = "_blank",
    ...
    "Cordero, F., et al. 'Dissecting minimal residual disease dynamics to improve outcome prediction in mantle cell lymphoma: Data from the FIL-MCL0208 clinical trial', HemaSphere (2026)."
              ...
              tags$a(
                ...
                target = "_blank",
                icon("github"), " CONNECTOR GitHub",
                style = "color: #1d8fbd; font-weight: bold;"
              )
            ),
            br(),
            img(src = "loghi.png", width = "80%", style = "opacity: 0.8;")
          )
        )
      ),
      tabItem(
            ...
            column(
              ...
              tabsetPanel(
                ...
                tabPanel("Clustering",
                  ...
                  fluidRow(
                    column(12, plotOutput("MCL_clusteringPlot", height = "600px"))
                  )
                ),
                tabPanel("Clinical assessment",
                  value = "panel_Clinical",
                  fluidRow(
                    column(
                      3,
                  ...
                  box(
                    title = h2("Statistical Analysis"), width = 12, collapsible = T, collapsed = T,
                    status = "primary",
                    fluidRow(
                      column(
                        6,
                  ...
                  box(
                    title = h2("Qualitative Analysis - Gene Mutations"), width = 12,
                  ...
                  box(
                    title = h2("Pharmacogenomic Analysis"), width = 12,
                    collapsible = T, collapsed = T,
                    status = "primary",
                    fluidRow(
                      selectInput(
                        inputId = "pharma_varsMCL",
                        label = "Variables:",
                ...
                tabPanel("Survival analysis",
                  value = "panel_survMCL",
                  fluidRow(
                    column(6, selectInput("selectSurvMCL",
                      selected = "Clusters",
                ...
                tabPanel("Entropy",
                  ...
                  fluidRow(
                    column(
                      6,
                      plotOutput("MCL_linePlot", height = "400px")
                    ),
                    column(
                      6,
                      plotOutput("MCL_scatterPlot", height = "400px")
                    )
                  ),
                  fluidRow(
                    column(
                      ...
                      plotOutput("MCL_FittedCurve", height = "400px")
                    )
                  )
                ),
                tabPanel("Table",
        ...
        box(
          ...
          fluidRow(
            column(
              width = 6,
              conditionalPanel(
                condition = "input.YoungPanels == 'panel_YoungPlot'",
                sliderInput(
                  inputId = "Cut",
            ...
            column(
              width = 6,
              conditionalPanel(
                condition = "input.YoungPanels == 'panel_YmclSurv'",
          ...
          fluidRow(
            column(10,
              ...
              tabsetPanel(
                id = "YoungPanels",
                tabPanel("Classification and Survival analysis",
                  value = "panel_YmclSurv",
                  fluidRow(
                    column(12, plotOutput("classYoungPlot", height = "600px")),
                    column(12, plotOutput("survYoungPlot", height = "400px"))
                  )
                ),
                tabPanel("Data processing",
                  value = "panel_YoungPlot",
                  fluidRow(
                    column(12, plotOutput("linePlot")),
                    column(12, plotOutput("lineTruncPlot"))
                  )
                ),
                tabPanel("Classification & Landmark analysis",
                  value = "panel_Classification",
                  fluidRow(
                    column(
                      12,
                      plotOutput("classifiedCurve", height = "600px")
                    )
                  ),
                  fluidRow(
                    column(2,
                      offset = 9,
                      actionButton(
                        inputId = "saveLP_fromClass",
                        label = "Save Landmark Point"
                      )
                    )
                  )
                ),
                tabPanel("Saved Landmark results",
                  value = "panel_Summary",
                  fluidRow(
                    column(
                      12,
      ...
      tabItem(
        ...
        fluidRow(
          box(
            title = "Input Excel Data", status = "primary", solidHeader = TRUE, collapsible = TRUE,
            fileInput("file1",
              accept = c(".xlsx"),
              div(
          ...
          box(
            title = "Input TXT Data", status = "primary", solidHeader = TRUE, collapsible = TRUE,
            fileInput("file2",
              accept = c(".txt"),
              div(
                class = "icon-container",
          ...
          box(
            title = "Line Plot", status = "primary", solidHeader = TRUE,
      ...
      tabItem(
        tabName = "user_classification",
        h2("User Data Exploration"),
        fluidRow(
          column(
            width = 4,
            selectInput(
              inputId = "tissueBox_user",
              label = "Tissue:",
              choices = c("Bone Marrow" = "BM", "Peripheral Blood" = "PB"),
              selected = "Bone Marrow"
            )
        ...
        box(
          ...
          column(
            ...
            fluidRow(
              column(
                width = 6,
                conditionalPanel(
                  condition = "input.UserPanels == 'panel_UserPlot'",
                  sliderInput(
                    inputId = "Cut_user",
              ...
              column(
                width = 12,
                conditionalPanel(
                  condition = "input.UserPanels == 'panel_UserSurv'",
          ...
          column(
            ...
            tabsetPanel(
              id = "UserPanels",
              tabPanel("Classification and Survival analysis",
                value = "panel_UserSurv",
                fluidRow(
                  column(12, plotOutput("classUserPlot", height = "600px")),
                  column(12, plotOutput("survUserPlot", height = "400px"))
                )
              ),
              tabPanel("Data processing",
                value = "panel_UserPlot",
                fluidRow(
              ...
              tabPanel("Classification & Landmark analysis",
                value = "panel_UserClassification",
                fluidRow(
                  column(
                    12,
